...
const App = () => {
    ...
    function mergeClickHandler(mergeName) {
        history.push('/studies/' + encodeURIComponent(mergeName));
    }
            ...
            <React.Fragment>
                ...
                {user !== null ? (
                    <Switch>
                        <Route exact path="/">
                            <MergeManager
                                onClick={(name) => mergeClickHandler(name)}
                            />
                        </Route>
                        <Route exact path="/studies/:mergeName">
                            <MergePane />
                        </Route>
