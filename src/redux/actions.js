...
export const OPEN_MERGE = 'OPEN_MERGE';

export function openMerge(mergeName) {
    return { type: OPEN_MERGE, mergeName: mergeName };
}

export const CLOSE_MERGE = 'CLOSE_MERGE';

export function closeMerge() {
    return { type: CLOSE_MERGE };
}
...
export const MERGE_UPDATED = 'MERGE_UPDATED';

export function mergeUpdated(eventData) {
    return { type: MERGE_UPDATED, eventData };
}
