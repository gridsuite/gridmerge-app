 ...
 * @param mergeName the name of the merge to export
 * @param {String} title Title of the dialog
 * @param {String} message Message of the dialog
 */
const ExportDialog = ({ open, onClose, onClick, mergeName, title }) => {
    const [availableFormats, setAvailableFormats] = React.useState('');
    const [selectedFormat, setSelectedFormat] = React.useState('');
    const [loading, setLoading] = React.useState(false);
    const [downloadUrl, setDownloadUrl] = React.useState('');
    const [exportMergeErr, setExportMergeErr] = React.useState('');
    ...
    const handleClick = () => {
        ...
        if (selectedFormat) {
            ...
            setExportMergeErr(
                intl.formatMessage({ id: 'exportStudMergeErrorMsg' })
            );
        }
    };
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                ...
                {exportMergeErr !== '' && (
                    <Alert severity="error">{exportMergeErr}</Alert>
                )}
                {loading && (
                    <div
                        style={{
